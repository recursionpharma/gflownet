...
root = "/mnt/ps/home/CORP/lazar.atanackovic/project/gflownet-runs/logs/bgfn_wo_detach_enc_true_logZ_subTB_Dec_22"
...
hps = [
    {
        **base_hps,
        ...
        "log_tags": ["bgfn_enc_true_logZ_wo_detach"],
        "seed": seed,
        "opt": {"learning_rate": 1e-4}, # o.g. 1e-4,
        "run_valid_dl": True,
        ...
        "cond": {
            "logZ":{
                ...
                #"dist_params": dist_params, # set to None to not sample cond_info for logZ
    ...
    for reward in ['even_neighbors'] #['const', 'count', 'even_neighbors', 'cliques']
    for data_distribution in ["uniform", "log_rewards"] #["uniform", "log_rewards", "log_p", "l2_log_error_gfn", "l1_error_gfn"] # TODO implement "loss_gfn"
    for seed in [1]
    for data_ratio in [0.9, 0.7]
