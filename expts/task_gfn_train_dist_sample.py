...
root = "/mnt/ps/home/CORP/lazar.atanackovic/project/gflownet-runs/logs/gfn_random_TB_train_dist_sample_Nov_22"
...
hps = [
    {
        **base_hps,
        ...
        "log_tags": ["gfn_random_TB_train_dist_sample"],
        "seed": seed,
        "opt": {"learning_rate": 1e-4}, # o.g. 1e-4,
    ...
    for data_distribution in ["random"] #["uniform", "log_rewards", "log_p", "l2_log_error_gfn", "l1_error_gfn"] # TODO implement "loss_gfn"
